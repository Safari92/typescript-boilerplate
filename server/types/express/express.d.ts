...
declare module "express" {
    ...
    module e {
         ...
         *
         *     connect()
         *       .use(connect.static(__dirname + '/client', { maxAge: oneDay }))
         *
         * Options:
         *
         ...
         *
         *     connect()
         *       .use(connect.favicon('client/favicon.ico))
         *
         * @param path
         * @param options
         */
         ...
         * Defining Formats:
         *
         *   All default formats are defined this way, however it's client API as well:
         *
